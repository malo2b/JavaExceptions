...
public class De {
    ...
    */
    ...
    public De(int nFaces, String pnom) throws NullPointerException {
        if (pnom == "") {
            throw new IllegalArgumentException("Le nom ne doit pas etre une chaine vide !");
        } else if (pnom == null) {
            throw new NullPointerException("Le nom doit etre non null");
        } else {
            nom = pnom;
